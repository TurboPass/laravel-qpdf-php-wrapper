...
namespace TurboPass\LaravelQpdfPhpWrapper\Facades;
 ...
 * @method static bool rotate(string $path, \TurboPass\QpdfPhpWrapper\Enums\Rotation $direction, string $range)
 ...
 *
 * @see TurboPass\QpdfPhpWrapper\Pdf
 */
